...
exports.getEma9Cross = getEma9Cross;
var _marketService = require("./marketService.js");
 ...
 */
async function getEma9Cross(symbol) {
  // busca as últimas 10 velas de 30m
  const klines = await (0, _marketService.fetchKlines)(symbol, '30', 10);
