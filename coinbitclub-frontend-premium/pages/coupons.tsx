...
import { FiGift, FiCheck, FiAlertCircle, FiLoader, FiCopy, FiX } from 'react-icons/fi';
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-black">
        {/* Header */}
        <div className="bg-gradient-to-r from-yellow-400/20 to-pink-400/20 border-b border-yellow-400/30 p-6">
        ...
        {/* Success Message */}
        {showSuccess && (
          <div className="fixed top-4 right-4 z-50 bg-green-400/20 border border-green-400/50 rounded-lg p-4 shadow-lg backdrop-blur-sm">
        ...
        <div className="max-w-4xl mx-auto p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Aplicar Cupom */}
            <div className="bg-black/90 backdrop-blur-sm border-2 border-yellow-400/50 rounded-xl p-6 shadow-[0_0_30px_rgba(255,215,0,0.3)]">
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full px-6 py-3 text-black bg-yellow-400 hover:bg-yellow-300 disabled:bg-yellow-400/50 disabled:cursor-not-allowed border-2 border-yellow-400 rounded-lg transition-all duration-300 font-bold flex items-center justify-center"
                >
                  {loading ? (
                    <>
