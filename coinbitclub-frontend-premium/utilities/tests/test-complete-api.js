...
async function testCompleteAPI() {
  try {
    console.log('🧪 Testando API completa do dashboard...\n');
    ...
    console.log('🔄 Buscando dados de trading...');
    ...
    // 3. SINAIS DE TRADING
    console.log('🔄 Buscando dados de sinais...');
    ...
    // 4. SINAIS IA
    console.log('🔄 Buscando dados de IA...');
    ...
    console.log('🔄 Buscando saldos dos usuários...');
    ...
    console.log('\n✅ API DASHBOARD TESTADA COM SUCESSO!');
    console.log('\n📊 RESUMO DOS DADOS REAIS:');
    console.log(`👥 Usuários: ${dashboardData.users.total} total, ${dashboardData.users.active} ativos, ${dashboardData.users.newThisMonth} novos este mês`);
    console.log(`📈 Trading: ${dashboardData.trading.totalOperations} operações, ${dashboardData.trading.profitableOperations} lucrativas, $${dashboardData.trading.totalProfitLoss} lucro total`);
    console.log(`📡 Sinais: ${dashboardData.signals.total} total, ${dashboardData.signals.processed} processados, ${dashboardData.signals.pending} pendentes`);
    console.log(`🤖 IA: Confiança média de ${dashboardData.signals.avgConfidence.toFixed(1)}%`);
    console.log(`👥 Afiliados: ${dashboardData.affiliates.total} total, ${dashboardData.affiliates.active} ativos`);
    console.log(`💰 Financeiro: $${dashboardData.financial.totalDeposits.toFixed(2)} depósitos, $${dashboardData.users.totalBalance.toFixed(2)} saldo total`);
    
    console.log(`\n🎯 STATUS: API PRONTA PARA PRODUÇÃO!`);
    console.log(`🔗 Endpoint: /api/admin/dashboard-real`);
    console.log(`📊 Dados: 100% reais do PostgreSQL`);
    console.log(`⚡ Performance: Todas as queries executadas com sucesso`);
