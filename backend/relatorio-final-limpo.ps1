...
Write-Host "URL Backend: https://coinbitclub-market-bot-v3.up.railway.app" -ForegroundColor White
...
Write-Host "SEGURANCA E AUTENTICACAO:" -ForegroundColor Cyan
...
Write-Host "  STRIPE_SUCCESS_URL: https://coinbitclub-market-bot-v3.up.railway.app/sucesso"
Write-Host "  STRIPE_CANCEL_URL: https://coinbitclub-market-bot-v3.up.railway.app/cancelado"
...
Write-Host "  REACT_APP_API_URL: https://coinbitclub-market-bot-v3.up.railway.app"
...
Write-Host "======================" -ForegroundColor Yellow
Write-Host "Health Check: https://coinbitclub-market-bot-v3.up.railway.app/health"
Write-Host "API Data: https://coinbitclub-market-bot-v3.up.railway.app/api/data"
Write-Host "Webhook TradingView: https://coinbitclub-market-bot-v3.up.railway.app/api/webhooks/tradingview"
Write-Host "Stripe Webhook: https://coinbitclub-market-bot-v3.up.railway.app/api/stripe/webhook"
Write-Host "Admin Panel: https://coinbitclub-market-bot-v3.up.railway.app/admin"
...
Write-Host "   curl https://coinbitclub-market-bot-v3.up.railway.app/api/data"
Write-Host ""
Write-Host "Testar Webhook Stripe:"
Write-Host "   curl -X POST https://coinbitclub-market-bot-v3.up.railway.app/api/stripe/webhook"
Write-Host ""
Write-Host "Testar Webhook TradingView:"
Write-Host "   curl -X POST https://coinbitclub-market-bot-v3.up.railway.app/api/webhooks/tradingview -H 'Content-Type: application/json' -d '{\"token\":\"210406\"}'"
Write-Host ""
...
Write-Host "CONFIGURACAO DO FRONTEND:" -ForegroundColor Yellow
Write-Host "=========================" -ForegroundColor Yellow
Write-Host "Repositorio: https://github.com/coinbitclub/coinbitclub-market-bot.git"
Write-Host "Deploy Vercel: https://coinbitclub-market-bot.vercel.app"
Write-Host "API URL: https://coinbitclub-market-bot-v3.up.railway.app"
Write-Host ""
Write-Host "VARIAVEIS NECESSARIAS NO VERCEL:"
Write-Host "   REACT_APP_API_URL=https://coinbitclub-market-bot-v3.up.railway.app"
...
Write-Host "===================================" -ForegroundColor Yellow
Write-Host "URL: https://coinbitclub-market-bot-v3.up.railway.app/api/webhooks/tradingview"
...
Write-Host "Metricas: Dashboard Railway"
...
Write-Host "6. Documentar mudancas para a equipe"
Write-Host ""
...
Write-Host "INFORMACOES DE SUPORTE:" -ForegroundColor Yellow
Write-Host "=======================" -ForegroundColor Yellow
...
Write-Host "Executando verificacao final..." -ForegroundColor Yellow
...
Write-Host "================" -ForegroundColor Yellow
Write-Host "Para monitorar em tempo real:"
