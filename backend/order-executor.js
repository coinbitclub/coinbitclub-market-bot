...
/**
 * EXECUTOR DE ORDENS - COINBITCLUB MARKET BOT V3.0.0
 * 
 * Executor de Ordens do sistema de trading
 * Tipo: microservico
 * Prioridade: 8
 */
...
class executorDeOrdens {
    constructor() {
        this.id = 'order-executor';
        this.nome = 'Executor de Ordens';
        this.tipo = 'microservico';
        this.status = 'inicializando';
        this.dependencias = ["risk-manager"];
        this.metricas = {
...
if (require.main === module) {
    const componente = new executorDeOrdens();
    componente.inicializar().catch(console.error);
}

module.exports = executorDeOrdens;