...
/**
 * MONITOR DE PORTFÓLIO - COINBITCLUB MARKET BOT V3.0.0
 * 
 * Monitor de Portfólio do sistema de trading
 * Tipo: microservico
 * Prioridade: 9
 */
...
class monitorDePortfLio {
    constructor() {
        this.id = 'portfolio-monitor';
        this.nome = 'Monitor de Portfólio';
        this.tipo = 'microservico';
        this.status = 'inicializando';
        this.dependencias = ["order-executor"];
        this.metricas = {
...
if (require.main === module) {
    const componente = new monitorDePortfLio();
    componente.inicializar().catch(console.error);
}

module.exports = monitorDePortfLio;