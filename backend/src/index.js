// src/index.js
import "express-async-errors";               // captura erros em routes async
...
// Rejeita body não-JSON em POST/PUT/PATCH
...
// Trata promessas rejeitadas e exceções não capturadas
