...
/**
 * PROCESSADOR DE PAGAMENTOS - COINBITCLUB MARKET BOT V3.0.0
 * 
 * Processador de Pagamentos do sistema de trading
 * Tipo: apoio
 * Prioridade: 11
 */
...
class processadorDePagamentos {
    constructor() {
        this.id = 'payment-processor';
        this.nome = 'Processador de Pagamentos';
        this.tipo = 'apoio';
...
if (require.main === module) {
    const componente = new processadorDePagamentos();
    componente.inicializar().catch(console.error);
}

module.exports = processadorDePagamentos;