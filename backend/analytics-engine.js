...
/**
 * MOTOR DE ANALYTICS - COINBITCLUB MARKET BOT V3.0.0
 * 
 * Motor de Analytics do sistema de trading
 * Tipo: apoio
 * Prioridade: 12
 */
...
class motorDeAnalytics {
    constructor() {
        this.id = 'analytics-engine';
        this.nome = 'Motor de Analytics';
        this.tipo = 'apoio';
        this.status = 'inicializando';
        this.dependencias = ["portfolio-monitor"];
        this.metricas = {
...
if (require.main === module) {
    const componente = new motorDeAnalytics();
    componente.inicializar().catch(console.error);
}

module.exports = motorDeAnalytics;